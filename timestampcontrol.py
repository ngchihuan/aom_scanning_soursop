...
READPROG='/home/qitlab/programs/timestamp3/readevents3'
...
def folder(directo,base_folder='/home/qitlab/data/timestamp'):
    ...
    month = currentdate[1]
    day =  currentdate[2]
    directory = base_folder + '/'+ year + '/'  + month + '/' + day  + '/'+directo+'/'
...
def stop():
    sp.Popen(["while [[ `pgrep -f readevents3` ]]; do `pkill -f -9 readevents3`; sleep 3; done"],shell=True)
